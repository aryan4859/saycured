...
def saycured_settings(request, slug):
    context = {}
    ...
    context['settings_nav_active'] = 'active'
    context['saycured_settings_li'] = 'active'
    context['settings_ul_show'] = 'show'

    return render(request, 'scanEngine/settings/saycured.html', context)
...
def notification_settings(request, slug):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            send_slack_message('*saycured*\nCongratulations! your notification services are working.')
            send_lark_message('*saycured*\nCongratulations! your notification services are working.')
            send_telegram_message('*saycured*\nCongratulations! your notification services are working.')
            send_discord_message('**saycured**\nCongratulations! your notification services are working.')
            messages.add_message(
                request,
                messages.INFO,
