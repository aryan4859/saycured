...
from saycured.validators import validate_short_name
...
class ReportForm(forms.ModelForm):
    ...
    show_saycured_banner = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
                "id": "show_saycured_banner",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['show_saycured_banner'] = key.show_saycured_banner
    ...
    def set_initial(self):
        self.initial['show_saycured_banner'] = True
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool saycuRed.
