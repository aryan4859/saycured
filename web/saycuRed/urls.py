...
from saycuRed.views import serve_protected_media

schema_view = get_schema_view(
   openapi.Info(
      title="saycuRed API",
      default_version='v1',
      description="saycuRed: An Automated reconnaissance framework.",
      contact=openapi.Contact(email="aryanstha4859@gmail.com"),
   ),
   public=True,
...
# ] + static(settings.MEDIA_URL, document_root=settings.saycuRed_RESULTS) + \
